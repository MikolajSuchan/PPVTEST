...
export const deleteEmployee = createAction(DELETE_EMPLOYEE,props<{emptyId:number}>())
export const deleteEmployeeSuc = createAction(DELETE_EMPLOYEE_SUCC, props<{ emptyId:number }>())
...
export const getEmployee = createAction(GET_EMPLOYEE,props<{emptyId:number}>())
